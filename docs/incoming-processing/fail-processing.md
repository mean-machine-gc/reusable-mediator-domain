...
[fail-processing.spec.md](https://github.com/mean-machine-gc/reusable-mediator-domain/blob/main/src/domain/incoming-processing/fail-processing/fail-processing.spec.md).
