...
[mediate-processing.spec.md](https://github.com/mean-machine-gc/reusable-mediator-domain/blob/main/src/domain/incoming-processing/mediate-processing/mediate-processing.spec.md).
