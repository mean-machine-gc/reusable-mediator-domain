...
[activate-mediation.spec.md](https://github.com/mean-machine-gc/reusable-mediator-domain/blob/main/src/domain/mediation/activate-mediation/activate-mediation.spec.md).
