...
| 2 | `deactivateMediationCore` | `STEP` | `not_active` |
...
| Scenario | `parseMediationId` :not_a_string | `parseMediationId` :empty | `parseMediationId` :too_long_max_64 | `parseMediationId` :not_a_uuid | `parseMediationId` :script_injection | `checkDeactivatableState` :not_active | `findMediation` :find_failed | `generateTimestamp` :generate_timestamp_failed | `saveMediation` :save_failed | Outcome |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | --- |
