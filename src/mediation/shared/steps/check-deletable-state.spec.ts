...
export type CheckDeletableStateFailure = 'not_draft_or_deactivated'
export type CheckDeletableStateSuccess = 'deletable-state-confirmed'
...
// ── Spec ───────────────────────────────────────────────────────────────────
export const checkDeletableStateSpec: FunctionSpec<
  Mediation, DraftMediation | DeactivatedMediation, CheckDeletableStateFailure, CheckDeletableStateSuccess
> = {
  constraints: {
