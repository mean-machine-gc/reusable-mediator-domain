...
export type CheckUpdatableStateFailure = 'not_draft_or_deactivated'
export type CheckUpdatableStateSuccess = 'updatable-state-confirmed'
...
// ── Spec ───────────────────────────────────────────────────────────────────
export const checkUpdatableStateSpec: FunctionSpec<
  Mediation, DraftMediation | DeactivatedMediation, CheckUpdatableStateFailure, CheckUpdatableStateSuccess
> = {
  constraints: {
