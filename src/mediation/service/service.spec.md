...
| 7 | `evaluateSuccessType` | `STEP` | Classify outcome based on dispatches and skipped counts | -- |

---

## Decision Table

| Scenario | `extractEventType` :missing_dataschema | `validateEventData` :schema_validation_failed | `mediateAll` :unknown_transform | `(own)` :schema_not_found | Outcome |
| --- | :---: | :---: | :---: | :---: | --- |
