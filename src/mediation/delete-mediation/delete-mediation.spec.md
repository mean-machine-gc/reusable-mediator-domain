...
| 2 | `deleteMediationCore` | `STEP` | `not_draft_or_deactivated` |
| 3 | `findMediation` | `DEP` | `find_failed` |
| 4 | `deleteMediation` | `DEP` | `delete_failed` |
...
| Scenario | `parseMediationId` :not_a_string | `parseMediationId` :empty | `parseMediationId` :too_long_max_64 | `parseMediationId` :not_a_uuid | `parseMediationId` :script_injection | `checkDeletableState` :not_draft_or_deactivated | `findMediation` :find_failed | `deleteMediation` :delete_failed | Outcome |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | --- |
...
| ❌ delete_failed | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✗ | Fails: `delete_failed` |
